...
#This project was write by Filip Zdebel with use of examples from Github in customtkinter library.
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # configure window
        self.title("Boat Controller API for ESP8266 Boat Webserver")
